...
function ToggleFishSwimming() {
    if (fishSwimming === true) {
        ...
        document.getElementById("ButtonToggleSwimming").style.backgroundImage = "url('ButtonPlay.png')";
    }
    else {
        fishSwimming = true;
        document.getElementById("Fish").className = "FishSwimming";
        document.getElementById("ButtonToggleSwimming").style.backgroundImage = "url('ButtonPause.png')";
    }
}
